...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 747, 1166))
        ...
        self.gridLayout_2.addWidget(self.groupBox_results, 5, 0, 1, 1)
        ...
        self.doubleSpinBox_milling_angle = QtWidgets.QDoubleSpinBox(self.groupBox_controls)
        ...
        self.doubleSpinBox_milling_angle.setProperty("value", 18.0)
        self.doubleSpinBox_milling_angle.setObjectName("doubleSpinBox_milling_angle")
        self.gridLayout_3.addWidget(self.doubleSpinBox_milling_angle, 2, 1, 1, 1)
        self.label_fib_view_information = QtWidgets.QLabel(self.groupBox_controls)
        self.label_fib_view_information.setObjectName("label_fib_view_information")
        self.gridLayout_3.addWidget(self.label_fib_view_information, 0, 0, 1, 2)
        ...
        self.gridLayout_3.addWidget(self.pushButton_toggle_correlation_mode, 1, 0, 1, 2)
        self.label_milling_angle = QtWidgets.QLabel(self.groupBox_controls)
        self.label_milling_angle.setObjectName("label_milling_angle")
        self.gridLayout_3.addWidget(self.label_milling_angle, 2, 0, 1, 1)
        self.pushButton_generate_fib_view = QtWidgets.QPushButton(self.groupBox_controls)
        self.pushButton_generate_fib_view.setObjectName("pushButton_generate_fib_view")
        self.gridLayout_3.addWidget(self.pushButton_generate_fib_view, 3, 0, 1, 2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_fib_view_information.setText(_translate("MainWindow", "TextLabel"))
        self.pushButton_toggle_correlation_mode.setText(_translate("MainWindow", "Enable Correlation Mode"))
        self.label_milling_angle.setText(_translate("MainWindow", "TextLabel"))
        self.pushButton_generate_fib_view.setText(_translate("MainWindow", "Generate FIB View"))
